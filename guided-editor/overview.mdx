---
title: "Guided Editor"
description: "The guided workflow editor for technical users who want step-by-step control over their automation logic."
icon: "wand-magic-sparkles"
---

The Guided Editor is designed for more technical users who want fine-grained, step-by-step control over their workflow logic. Unlike the [Agentic Editor](/agents/introduction), which lets you describe what you want in natural language and have an AI agent build it, the Guided Editor gives you direct control over each step, its configuration, and how data flows between them.
