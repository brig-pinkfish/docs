...
- **[Gmail Connector](/api-reference/mcp-servers/application/gmail)**: Send through your Gmail account with full email management capabilities
- **[Microsoft Outlook Connector](/api-reference/mcp-servers/application/microsoft-outlook)**: Send through your Outlook/Office 365 account with integrated calendar and task features
...
> **See the complete [Email Outbound Guide](/api-reference/mcp-servers/embedded/email) for detailed usage, parameters, and examples.**
