...
Pinkfish AI provides access to a comprehensive collection of MCP servers, each offering specialized tools for different use cases. Here's the complete list of available servers:
...
- **`pinkconnect`** - PinkConnect server for managing user connections and integrations
...
- **`think`** - Think server for complex reasoning and problem-solving
- **`ai-agent`** - AI Agent server for complex reasoning and multi-step operations
...
Some servers have dependencies on others:
- **Google Workspace**: Google Sheets, Slides, and Docs depend on Google Drive for file listing and search
- **Microsoft 365**: Excel, PowerPoint, and Word can work directly with OneDrive files without downloading
- **Integration Requirements**: External services require proper authentication and API access to function

This comprehensive collection of MCP servers enables your agents to interact with virtually any external service or internal tool, providing powerful automation capabilities across your entire workflow.