...
<img src="/images/agents/monitor-tab.png" alt="Monitor tab inside the builder showing a left-side chat list with a Search here... input and 'No chats found.' empty state, and a right-side message viewer showing a 'No Chat Selected — Select a chat from the list to view monitor activity.' empty state with Expand all, sort order, and message action controls" />
