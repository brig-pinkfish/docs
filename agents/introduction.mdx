...
- **[Datastores](/essentials/database)**, **[Filestores](/essentials/file-store)**, **[Knowledge Bases](/essentials/knowledge-base)** — The three resource types you can attach.
- **[API connections](/essentials/connections)** — The integrations that feed the Tools tab.
