...
- **[Coworker](/essentials/coworker)** — Where released agents appear for `@`-mention and chat.
- **[Agent Monitor](/essentials/agent-monitor)** — Org-wide view of every agent chat across all users.
- **[Datastores](/essentials/datastore)**, **[Filestores](/essentials/filestore)**, **[Knowledge Bases](/essentials/knowledgebase)** — The three resource types you can attach.
- **[API connections](/essentials/api-connections)** — The integrations that feed the Tools tab.
