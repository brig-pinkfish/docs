...
<Card title="Agent Memory" icon="brain" href="/api-reference/mcp-servers/embedded/pinkfish-sidekick">
...
- **[Agent Monitor](/orchestration/monitor)** — Org-wide view of every agent chat across all users.
