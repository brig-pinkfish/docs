...
The **Monitor** tab at the top of `/agents` is the org-wide agent chat feed. It's identical to the standalone [Agent Monitor](/essentials/agent-monitor) page — the same data, opened through a different entry point.
...
- [Agent Monitor](/essentials/agent-monitor) — the org-wide monitoring page.
