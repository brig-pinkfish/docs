...
<img src="/images/agents/resources-tab.png" alt="Resources tab for the Sales Assistant agent with Show Selected (2) active — the Knowledge Bases section is expanded and shows two attached 'Blueberries Chat Collection' entries in a table with columns Name, Read, Write, Admin. The first row has Read + Write checked; the second has Read only." />
...
See [Datastore](/essentials/database) for how to create one.
...
See [Filestore](/essentials/file-store) for details.
...
See [Knowledge Base](/essentials/knowledge-base) for ingestion details.
...
- [Datastore](/essentials/database) — how to create and populate structured/unstructured datastores.
- [Filestore](/essentials/file-store) — binary-file storage.
- [Knowledge Base](/essentials/knowledge-base) — semantic search over documents.
