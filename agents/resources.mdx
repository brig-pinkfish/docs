...
Resources are **data**. Unlike [Tools](/agents/connect-tools), which are actions the agent can take, resources define what the agent can read, write to, or administer.
...
- [Tools tab](/agents/connect-tools) — actions (not data).
