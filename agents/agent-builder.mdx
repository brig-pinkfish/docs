...
<img src="/images/agents/agent-builder-overview.png" alt="Agent Builder opened on an agent called Sales Assistant — Instructions tab is active on the left with the agent name, instructions, and other fields visible; the right side shows the Test preview pane for live chat" />
...
<img src="/images/agents/agent-builder-tabs.png" alt="Builder tabs strip showing Instructions and Tools plus a + button for pinning additional tabs" />
...
<img src="/images/agents/agent-builder-information.png" alt="Information pane showing Selected Model (Sonnet 4.5), Selected Tools section, Auto-selected Tools list (Write Artifact, Read Artifact, List Artifacts, Write Artifact from URL, Run Code), and Selected Resources (0)" />
