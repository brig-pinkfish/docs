...
<img src="/images/agents/instructions-tab.png" alt="Instructions tab for the Sales Assistant agent showing the Agent Name, Agent Instructions with a filled system prompt, and collapsed Agent Icon / Agent Description / Model / Prompt Bubbles sections" />
