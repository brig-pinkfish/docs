...
- For other ways to start a workflow or agent, see [Triggers](/triggers/event-triggers). For Coworker inside the Pinkfish app, see [Coworker](/get-started/coworker).
