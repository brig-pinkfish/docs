...
The `/crawl-map` command enables you to generate a comprehensive map of website URLs starting from a given URL. Perfect for:

- Discovering all pages on a website
- Finding specific content pages
- Planning web scraping strategies
- Site structure analysis
- Content auditing

## Basic Usage

Use the command to map website URLs:

```
/crawl-map generate map for "https://lights.com/"
```

```
/crawl-map find pages containing "Foscarini" on "https://lights.com/"
```

```
/crawl-map map "https://example.com/" including subdomains
```
