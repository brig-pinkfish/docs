...
- `collectionId` - Collection ID for storing output files (if not specified, logs, downloads, and scraped results are stored in the Multimedia Artifact Collection by default)
