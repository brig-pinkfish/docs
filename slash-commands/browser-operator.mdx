...
Files downloaded during browser automation are automatically captured and saved to your collection. Browser Operator monitors download activity and retrieves all downloaded files after the session completes.
...
3. After task completion, files are retrieved and saved to your collection
