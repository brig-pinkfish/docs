...
- `model` - Specific model to use (defaults to moonshotai/kimi-k2-instruct-0905)
...
```
Processes long documents using a model with extended 262K context length.

### Notes 

Available models include moonshotai/kimi-k2-instruct-0905 (262K context, default), openai/gpt-oss-120b, llama-3.3-70b-versatile, llama-3.1-8b-instant, qwen/qwen3-32b, and groq/compound. Default response format is JSON. 
...
- **`moonshotai/kimi-k2-instruct-0905`** (default) - Fast reasoning, extended 262K context
