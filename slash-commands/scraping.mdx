...
description: "Learn how to use scraper skill in your workflows"
---
...
- Or alternatively, using _secrets_ you've stored in the datastore you can fill in username, password, and apikey details without needing to copy/paste those details into your workflow as plaintext.
