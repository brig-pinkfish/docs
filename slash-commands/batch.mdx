...
```
/batch
queueId: queue-to-use
triggerId: workflow-to-run
csvData:
...
[
  {
    ...
    "onDoneTriggerId": "trigger-completion-456",
...
```
/batch
queueId: process-queue
triggerId: data-processor
csvData:
email,name,status
...
triggerId: customer-import
csvUrl: https://example.com/customers.csv
onDoneTriggerId: send-summary-email
```
...
```
/batch
queueId: product-updates
triggerId: update-product-workflow
