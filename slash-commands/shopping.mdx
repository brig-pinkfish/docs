...
description: "Learn how to use the shopping slash command for competitive pricing analysis"
---

The `/shopping` command helps you analyze competitive pricing across multiple retailers. Perfect for:
