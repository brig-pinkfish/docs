---
title: "Office Template Fill Guide"
...
**From Uploaded File:**
```javascript
template_source: "uploaded_file:template.docx"
```

**From Previous Step's Output:**
```javascript
template_source: "artifact:generated-template.docx:step-2"
```

**From URL:**
```javascript
template_source: "url:https://example.com/templates/report.docx"
```
