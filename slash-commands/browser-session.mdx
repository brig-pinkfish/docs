...
The `/browser-session` command enables you to automate web browser interactions using Playwright. Perfect for:
...
Use the command to automate browser tasks:

```
/browser-session navigate to "https://example.com" and extract product data
```

```
/browser-session login to website with username "user" and password "pass"
```

```
/browser-session fill form and submit data
```
