...
- **Light format**: File ID, filename, filepath, type, mime_type, size, isPublic status, collectionId, timestamps, and metadata object
...
- **File overwriting**: Creating a file with an existing filename will overwrite the existing file completely
