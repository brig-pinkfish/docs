...
Extract product listings with prices, images, and descriptions.

### Form Automation
Fill out and submit complex multi-page forms.

### Data Extraction from Dashboards
Login and extract data from authenticated portals.

### Document Download Automation
Navigate through sites to find and download specific documents.

### Screenshot Capture
Capture visual evidence of page states or content.

### Table/List Extraction
Scrape structured data from tables and lists.

### PDF Generation
Navigate to pages and save as PDFs.

### Testing & Validation
Verify website functionality and content.
