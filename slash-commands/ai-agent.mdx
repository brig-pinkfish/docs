...
One of the most powerful features of the AI Agent framework is the ability to create and use tools on Pinkfish. A tool is just a regular automation where you get something done. Add an API Trigger to your automation and give the API details to your AI Agent.
