...
- Make sure that the threadId is sent back in the next call to this agent automation if you want to the agent to continue the conversation. Without the threadId, the agent will start a new conversation.
