...
- Pro tip: make sure that the threadId is sent back in the next call to this agent automation if you want to the agent to continue the conversation. Without the threadId, the agent will start a new conversation.
...
- Pro tip: attach your agent prompt to the automation as a file and import it in step one. This will make editing and replacing your prompt easier.
        ...
        <tool_template name="spreadsheet-parser">
            {
                ...
                "toolUrl": "https://triggers.app.pinkfish.ai/ext/triggers/YOUR_TRIGGER_ID",
...
- SMS (see: [SMS Triggers](/how-to/sms-triggers))
- Email
- Slack
- Web chat
