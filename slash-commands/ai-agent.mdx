...
Here is a screenshot of a three step automation that follows the model above. You can see in this example that I've put the agent prompt in a file and attached the file to the automation (and retrieved it as part of step 1). In step3 shown below, I'm sending out the email response using the Sendgrid connection.
