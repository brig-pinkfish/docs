...
callbackPayload: {"crawlId": "{{results.id}}", "status": "{{results.status}}", "totalPages": "{{results.total}}", "completedPages": "{{results.completed}}", "creditsUsed": "{{results.creditsUsed}}", "data": "{{results.data}}", "message": "Website crawl completed: {{results.completed}}/{{results.total}} pages processed"}
pollTime: 15m
pollFrequency: 30s
```
