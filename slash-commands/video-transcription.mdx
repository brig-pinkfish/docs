---
title: "Video Transcription Guide (Deprecated)"
...
While processing, the placeholder file will show:

```
Audio transcription started with gemini-2.5-flash.
The transcribed text will be available here when processing is complete.

Response ID: gemini-async-queue-1759940444044-igcosd4ai
Status: queued
Created: 2025-10-08T16:20:44.044Z
Model: gemini-2.5-flash
Type: transcription

This file will be automatically updated with the transcribed text once processing completes.
```

Once complete, the file will be automatically updated with the full transcript.
