---
title: "Structure JSON Command Guide"
description: "Learn how to use the Structure JSON slash command"
---
...
Transform any unstructured text, documents, or data into clean, structured JSON objects. Perfect for data extraction, API integration, and automated data processing.
...
```
/json-structure
content: the unstructured data to convert
```

### Parameters
- **content**: The unstructured text or data to structure
- **file** (optional): File URL containing data to structure
- **schema** (optional): Desired JSON structure or schema to follow

### Response Format
Returns data as clean JSON without any additional text or formatting.
...
```
/json-structure
content: "John Smith, age 35, lives in New York and works as a software engineer"
```
...
schema: {"name": "", "age": 0, "location": "", "occupation": ""}
```
...
```
/json-structure
content: "Meeting on Jan 15 with Sarah and Mike. Discussed Q1 budget of $50k and project timeline ending March 31"
```
