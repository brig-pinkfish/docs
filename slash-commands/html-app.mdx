...
description: "Learn how to use the HTML App slash command to create powerful web applications"
---

## Why Use HTML App?

The `/html-app` command enables you to create sophisticated web applications with simple natural language commands. Perfect for:
...
```
/filestorage write the result from the previous step to "customer-feedback-form"
```
