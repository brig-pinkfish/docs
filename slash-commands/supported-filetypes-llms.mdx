---
title: "LLM File Type Support"
description: "Comprehensive guide to which file types are supported by different LLM models"
---

# LLM File Type Support

This document lists which file types are natively supported by different LLM models, as well as files that can be processed using preprocessors.
...
These file types can be processed and converted to text/CSV format for use with **ANY** model:
