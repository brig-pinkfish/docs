---
title: "Image Edit Command Guide"
description: "Premium text-based image editing with maximum performance using black-forest-labs/flux-kontext-max"
---

## What can you do with it?

The `/image-edit` command enables you to perform advanced text-based image editing using the premium Flux Kontext Max model. You can modify existing images through natural language instructions, add or remove elements, change styles, improve typography, enhance compositions, and create sophisticated image manipulations with professional-grade results.
...
- `input_image` - Image to use as reference (URL or uploaded file). Must be jpeg, png, gif, or webp
...
**Model Capabilities:**
- Premium text-based editing with maximum performance
...
**Limitations:**
- Requires input image for most editing tasks
- Safety tolerance is limited when using input images
- Processing time varies based on edit complexity
- Results depend on input image quality and prompt clarity

### Model Parameters (black-forest-labs/flux-kontext-max)

#### Text-Based Image Editing Parameters
