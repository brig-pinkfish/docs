...
- `model` - Specific Gemini model to use (defaults to gemini-2.5-flash-lite)
...
- **`gemini-2.5-flash-lite`** (default) - Cost-efficient, ultra-fast tasks
- **`gemini-2.5-flash`** - Fast, general tasks
- **`gemini-2.5-pro`** - Advanced reasoning, coding
- **`gemini-2.0-flash`** - High-volume, general tasks
