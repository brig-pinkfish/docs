---
title: "Long-Term Memory Guide"
description: "Learn how to use long-term memory to store and retrieve user-specific memories with agent context"
---
...
```
/long-term-memory [action] [userId | memoryId] [message] [options]
```
...
```
/long-term-memory get memories for user123 from agentId: ai-assistant-v1
```

Get compiled memory format:

```
/long-term-memory get memories for user123 with compiled: true
```
...
```
/long-term-memory update memory abc123def456 with:
...
```
/long-term-memory search memories for user123:
...
```
/long-term-memory get memories for user123 from agentId: coding-assistant
```
