...
### Re-adding the App
You can re-add the Pinkfish app at any time by following the [Adding the Pinkfish App](#adding-the-pinkfish-app) instructions above.
...
The level of support provided depends on your Pinkfish subscription plan:

**Starter, Pro, and Team Plans:**
- Support available via **Discord** for customer inquiries and responses
- Access to comprehensive [Documentation](https://docs.pinkfish.ai/) for troubleshooting and guidance

**Enterprise Plan:**
- **Standard Support** – Available **9 AM – 5 PM PST** on business days (included in Enterprise subscription)
- **Extended Support** – Custom time and timezone support (available for additional fee)
- **Technical Account Management (TAM) Support** – Assistance with custom configurations and implementations (available for additional fee)
- Up to **three designated contacts** authorized to submit and track support tickets
...
- Webhook events require proper verification using the secret token 