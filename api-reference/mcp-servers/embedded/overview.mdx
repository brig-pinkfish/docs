...
| ---------------------------------------------------------------------- | ---- | ----- | --------------------------------------------------------------------------- |
| [artifact-tools](/api-reference/mcp-servers/embedded/artifact-tools)   | N/A  | 4     | Create, read, and list downloadable files — always available to agents     |

Artifact tools are built into the agent runtime (not MCP servers). They require no configuration and are always available to Claude and GPT agents.
...
| [pinkfish workflows](/api-reference/mcp-servers/embedded/pinkfish-sidekick)         | `/pinkfish-sidekick` | 22    | Discovery, workflow lifecycle, triggers, orchestration  |
