...
```json
{
  "type": "object",
  "properties": {
    "request": { "type": "string", "description": "Natural language description of the task" },
    "types": {
      "type": "array",
      "items": { "type": "string", "enum": ["tool", "agentSkill", "connection", "resource"] },
...
{
  "structuredContent": {
    "tools": [{ "name": "gmail_search_emails", "serverName": "gmail", "hasSkill": false, "confidence": 0.95 }],
    "connections": [{ "name": "My Gmail", "id": "abc123-pcid", "application": "gmail", "confidence": 0.95 }],
    "resources": [],
    "skills": []
  }
}
...
```json
{
  ...
  "properties": {
    ...
    "includeResources": { "type": "boolean", "default": true, "description": "Include user connections and collections" },
    "refreshCache": { "type": "boolean", "default": false, "description": "Bypass cache for fresh data" }
  },
...
```json
{
  ...
  "properties": {
    ...
    "automationId": { "type": "string", "description": "If provided, initializes existing automation with starter code" }
  },
  "required": ["name"]
}
```
...
```json
{
  ...
  "properties": {
    ...
    "changeDescription": { "type": "string", "description": "Brief description of changes" },
    "bindings": { "type": "object", "description": "Resource bindings map (key: resource name, value: ID)" }
  },
...
```json
{
  ...
  "properties": {
    "automationId": { "type": "string", "description": "Automation ID" },
    "nodeId": { "type": "string", "description": "Get focused details for a specific node" },
    "includeCode": { "type": "boolean", "description": "Include full workflow code" },
    "checkResources": { "type": "boolean", "description": "Include resource binding status" },
    "addBetween": {
      "type": "object",
      "properties": { "sourceId": { "type": "string" }, "targetId": { "type": "string" } }
    },
    "expandDataFrom": { "type": "array", "items": { "type": "string" }, "description": "Node IDs to expand data from" }
  },
  "required": ["automationId"]
}
```
...
```json
{
  ...
  "properties": {
    ...
    "runUntilNode": { "type": "string", "description": "Stop execution after this node completes" }
  },
  "required": ["automationId"]
}
```
...
```json
{
  ...
  "properties": {
    "automationId": { "type": "string", "description": "Automation ID" },
    "runId": { "type": "string", "description": "Run ID from a previous workflow execution" }
  },
...
```json
{
  ...
  "properties": {
    ...
    "operation": { "type": "string", "enum": ["list", "search", "read", "getUrl"] },
    "runId": { "type": "string" },
    "pattern": { "type": "string" },
...
```json
{
  "type": "object",
  "properties": {
    "action": { "type": "string", "enum": ["create", "read", "update", "list", "invoke"] },
    "agentId": { "type": "string" },
    "name": { "type": "string" },
...
```json
{
  "type": "object",
  "properties": {
    "url": { "type": "string", "description": "Workflow trigger URL (webhookEndpoint)" },
    "payload": { "type": "object", "description": "Input parameters for the workflow" }
  },
  "required": ["url"]
}
```
