...
For full tool parameters and schemas, see the [agent-management server reference](/api-reference/mcp-servers/agent-management).
...
See the [full server reference](/api-reference/mcp-servers/agent-management) for parameters, schemas, and response formats for each tool.
