...
Both tools live on `/pinkfish-sidekick`. For full parameter schemas, see the [pinkfish-sidekick server reference](/api-reference/mcp-servers/pinkfish-sidekick).
