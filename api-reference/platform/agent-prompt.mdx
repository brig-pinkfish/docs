...
<Note>
**MCP vs HTTP:** When an agent is connected via Cursor, an IDE, or a custom MCP client, it receives tools it can invoke directly. For programmatic agents that call the API over HTTP, see [Dynamic Tool Discovery](/api-reference/platform/dynamic-tool-invocation).
</Note>
