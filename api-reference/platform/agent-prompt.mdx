...
System prompt for agents that call the MCP Farm. For workflow-building agents: [Workflow Builder Prompt](/api-reference/platform/workflow-builder-prompt). For HTTP-based agents: [Discover, Install, and Invoke](/api-reference/platform/discovery).
