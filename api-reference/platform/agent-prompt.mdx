...
description: "System prompts for connecting your own AI agent to the MCP Farm"
---
...
```
You have access to the Pinkfish MCP Farm — 1,953 tools across discovery, workflows, search, storage, AI models, and integrations.
