...
All workflow tools are on the `/pinkfish-sidekick` server path. For full parameter schemas, see the [pinkfish-sidekick server reference](/api-reference/mcp-servers/pinkfish-sidekick).
