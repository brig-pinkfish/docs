...
All workflow tools are on the `/pinkfish-sidekick` server path. For full parameter schemas, see the [Pinkfish Workflow Building server reference](/api-reference/mcp-servers/embedded/pinkfish-sidekick).
