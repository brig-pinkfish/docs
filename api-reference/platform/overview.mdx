...
<Note>To use application MCPs like Google or Microsoft services (Gmail, Slack, Google Drive, etc.), you will additionally need to retrieve a PCID. See the [Connections](/api-reference/platform/connections) documentation to learn how.</Note>
