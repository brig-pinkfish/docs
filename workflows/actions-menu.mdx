...
<Frame>
  <img src="/images/workflows/actions-menu/dropdown.png" alt="Workflow actions dropdown open from the chevron next to the workflow title — Description, Tag, Share, Duplicate, Delete, Rename, and Setup Integrations and Resources entries visible." />
</Frame>
...
See [Sharing](/organization/sharing) for the broader sharing model.
...
Opens the **Workflow Resources Modal** — a panel that lists every [connection](/tools/connections), data collection, file, and secret the workflow depends on. Use it to:
