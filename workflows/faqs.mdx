...
Check out our [Quickstart Guide](/introduction) to create your first workflow in minutes. You can also explore our [library](/workflows/library) of pre-built workflows for common use cases.
...
Yes! You can [duplicate workflows](/workflows/duplication) and modify them, or copy specific steps between workflows. This is a great way to build on your existing work.
...
Use [Triggers](/triggers/event-triggers) to automatically start your workflows. You can set up triggers for emails, webhooks, schedules, file uploads, and more.
...
Yes! Store your API keys and secrets securely in the [Vault](/resources/vault) and reference them in your workflows. This keeps your credentials safe and allows you to use your own service quotas.

### What file types can I work with?
Pinkfish supports a wide variety of file types including PDFs, Excel files, images, CSVs, and more. Check out our [file handling](/resources/file-store) guide for details.

## Sharing & Collaboration

### Can I share workflows with my team?
Yes! You can [share workflows](/organization/sharing) with specific team members or make them available to your entire organization. You can also [publish workflows](/agents/releases) to make them publicly available.

### How do I manage access to workflows?
Use your [organization settings](/organization/overview) to control who can view, edit, and run workflows. You can set permissions at the workflow level or for your entire organization.

## Credits & Pricing

### How do credits work?
Credits are consumed when you run workflow steps. Different operations (like AI processing, API calls, or file operations) use different amounts of credits. See our [credits guide](/billing/credits) for details.

### What are the usage limits?
Check our [limits page](/billing/limits) for current usage limits and quotas. These help ensure fair usage and system performance for all users.
...
Use the [Monitor](/orchestration/monitor) feature to track workflow runs, view logs, and identify issues. You can also test individual steps before running the full workflow.

### Can I integrate with external systems?
Absolutely! Pinkfish supports hundreds of [API integrations](/api-reference/mcp-servers/application/overview) including popular services like Google Workspace, Slack, Salesforce, and many more.
