...
<Frame>
  <img src="/images/workflows/interface-builder/interface-tab-open.png" alt="Interface tab open in the right pane on a new workflow, prompting 'First add a node to the workflow to enable adding an Interface.'" />
</Frame>
...
When you release the workflow and make it [publicly accessible](/workflows/releases#public-templates), users get a URL that serves the interface:
