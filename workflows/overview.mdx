...
<Frame>
  <img src="/images/workflows/overview/editor-populated.png" alt="Agent Mode editor showing a four-node weather-email workflow the coding agent built from a natural-language prompt — Start → Get SF Weather → Format Email Body → Send Weather Email." />
</Frame>
...
<CardGroup cols={3}>
  <Card title="Chat (left)" icon="comments" href="/workflows/coding-chat">
    The coding agent that builds, edits, and explains your workflow on demand.
  </Card>
  <Card title="Canvas (center)" icon="diagram-project" href="/workflows/canvas">
    The infinite node-graph where your workflow lives. Drag, connect, inspect.
  </Card>
  <Card title="Right pane (tabs)" icon="table-columns" href="/workflows/editor-tabs">
    Workflow, Result, Interface, Code, and Log — pin and rearrange the tabs you care about.
  </Card>
</CardGroup>

The right pane can be [split](/workflows/split-view) to show two tabs side-by-side — great for keeping the canvas and the output in view while you iterate.
...
- **Monitor** — the run-history view. Replaces the chat panel with a list of past runs and the canvas with a read-only execution view. See [Monitor tab](/workflows/monitor).
...
<CardGroup cols={2}>
  ...
  <Card title="Adding nodes" icon="square-plus" href="/workflows/adding-nodes">
  ...
  <Card title="Triggers" icon="bolt" href="/workflows/trigger-node">
  ...
  <Card title="Sticky notes & canvas" icon="note-sticky" href="/workflows/sticky-notes">
...
<CardGroup cols={2}>
  <Card title="Editor tabs" icon="table-columns" href="/workflows/editor-tabs">
    Workflow, Result, Interface, Code, and Log.
  </Card>
  <Card title="Split view" icon="object-group" href="/workflows/split-view">
...
<CardGroup cols={2}>
  ...
  <Card title="Releases & versions" icon="rocket" href="/workflows/releases">
    Promote drafts to live, compare versions, restore history, publish as a template.
  </Card>
  <Card title="Monitor" icon="chart-line" href="/workflows/monitor">
...
<CardGroup cols={2}>
  <Card title="Actions menu" icon="ellipsis-vertical" href="/workflows/actions-menu">
    Share, duplicate, tag, describe, and configure resources.
  </Card>
  <Card title="Coding agent chat" icon="comments" href="/workflows/coding-chat">
...
See [Canvas — Collaborating on the canvas](/workflows/canvas#collaborating-on-the-canvas) for what's shared in real time (cursors, node dragging, presence) versus what stays local (selections, edits, zoom).
...
<CardGroup cols={2}>
  <Card title="I'm new — build my first workflow" icon="play" href="/workflows/coding-chat">
    Open the chat and describe what you want.
  </Card>
  <Card title="I want to understand the canvas" icon="diagram-project" href="/workflows/canvas">
    The visual mechanics: dragging, connecting, zooming.
  </Card>
  <Card title="I need to browse node types" icon="cubes" href="/workflows/node-types">
    The full catalog of what you can place.
  </Card>
  <Card title="I want to run and debug" icon="play" href="/workflows/running">
