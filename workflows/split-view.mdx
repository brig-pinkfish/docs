...
<Frame>
  <img src="/images/workflows/split-view/split-on.png" alt="Editor in Split mode with two side-by-side panels and a divider between them." />
</Frame>
...
Split View is specific to the **Editor** view mode. When you switch to [Monitor mode](/workflows/monitor), the right pane takes over entirely and Split is not available.
