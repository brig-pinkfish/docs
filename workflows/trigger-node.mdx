...
<CardGroup cols={2}>
  ...
  <Card title="Interface" icon="window-maximize">
    Start from a user-facing form. See [Interface](/workflows/interface-builder).
  </Card>
</CardGroup>
...
- **Live URL** — hits the most recent [release](/workflows/releases) of the workflow.
...
<Frame>
  <img src="/images/workflows/trigger-node/schedule-trigger-settings.png" alt="Schedule Trigger settings panel with Timezone, Run every, and time-of-day fields filled in, plus an Input Payload editor." />
</Frame>
...
See [Running a Workflow](/workflows/running) for the full run flow.
