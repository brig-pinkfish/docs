...
- [**Docusign & MCP**](/slash-commands/docusign-mcp): Electronic signatures and contract management
- [**Azure SQL**](/slash-commands/azure-sql): Cloud-based relational database service
- [**LinkedIn Marketing**](/slash-commands/linkedin-marketing): Professional social media marketing
- [**Net Suite**](/slash-commands/net-suite): Cloud business software suite
- [**SAP**](/slash-commands/sap): Enterprise resource planning software
- [**AWSConnect**](/slash-commands/aws-connect): Cloud contact center service
- [**RFP-IO**](/slash-commands/rfp-io): RFP and proposal management
- [**Selligent**](/slash-commands/selligent): Customer engagement and marketing platform
- [**Pitchbook**](/slash-commands/pitchbook): Private market intelligence and data
- [**Iterable CRM**](/slash-commands/iterable-crm): Customer relationship management platform
