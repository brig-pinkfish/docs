...
<CardGroup cols="4">
  <Card title="Starter" icon="seedling" color="#4CAF50">
    Free tier for individuals exploring the platform
  </Card>
  <Card title="Pro" icon="user" color="#2196F3">
    For individual users with expanded features
  </Card>
  <Card title="Team" icon="users" color="#9C27B0">
    Multi-user with advanced collaboration features
  </Card>
...
<Tabs>
  ...
  <Tab title="Team">
    **$133/month — $99/month billed annually**
...
<Tabs>
  <Tab title="Monthly Plans">
    <CardGroup cols="2">
      <Card title="Pro Monthly" icon="calendar-days" color="#2196F3">
        $27.00/month
        5,000 credits included
      </Card>
      <Card title="Team Monthly" icon="users" color="#9C27B0">
        $133.00/month
  ...
  <Tab title="Annual Plans">
    <CardGroup cols="2">
      <Card title="Pro Annual" icon="calendar-check" color="#2196F3">
        $240.00/year ($20/month)
        60,000 credits included
      </Card>
      <Card title="Team Annual" icon="users-gear" color="#9C27B0">
...
Enterprise plans with custom pricing and credit allocations are available. [Contact sales](mailto:support@pinkfish.ai) for details.