...
Data Collections help organize related datastore items. When working with collections:

- Group items with similar key patterns and purposes
- View items in document or table format based on structure
- Reference collections directly in workflows via slash commands
- Share collections with team members (View/Edit permissions)
- Apply bulk operations across multiple data items
