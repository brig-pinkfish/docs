...
<img src="/images/examples/automation_sharing_modal.png" alt="Automation Sharing Modal" width="500" />
...
<Info>**Important notes about automation sharing specific to permission levels:**
...
- Since shared automations are meant to be a collaboration tool, if multiple users who have access attempt to make changes to the automation at the same time, a race condition will occur. The last user to save will overwrite the changes made by the others.
...
**Sharing Automations without sharing it's connections:**
...
**Sharing Automations and sharing it's connections:**
...
- If you later decide to unshare the connections, you will need to do so separately for each user or organization.

<img src="/images/examples/connection_config_modal.png" alt="Connection Sharing Modal" width="500" />

<Info>**Important notes about connection sharing specific to automation sharing:**
