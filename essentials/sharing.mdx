...
Every entity within Pinkfish can be shared. Currently Connections and Workflows can be shared easily within an organization. Here is how the sharing permissions work.
...
| **Data Store** | **Manage**       | Edit, Delete, Share data store collection                       | —                                        |
|                                | **View**       | Read from data store in workflows                               | Cannot write, edit, delete, or share     |
| **File Store** | **Manage**       | Edit, Delete, Share file store collection                       | —                                        |
|                                | **View**       | Read from file store in workflows                               | Cannot write, edit, delete, or share     |
| **Vault** | **Manage**       | Edit, Delete, Share vault collection                            | —                                        |
