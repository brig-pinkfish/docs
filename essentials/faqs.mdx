...
Yes! You can use various programming languages and frameworks within your workflows. Many of our [slash commands](/essentials/slash-commands) support custom code execution.
...
If you can't find the answer to your question here, please reach out to our [support team](mailto:support@pinkfish.ai) or check our [support overview](/support/overview) for more help options. 