...
Within a step, you can make use of various skills. Skills are capabilities that Pinkfish has been trained to do. For example, you can use any of the leading LLM skills, or image processing skill, or Connection skill to your favorite SaaS service.
