...
- Coworker can be connected to Slack and Microsoft Teams workspaces for use outside the Pinkfish app. See the [Slack Channel](/essentials/slack-channel) guide for details.
