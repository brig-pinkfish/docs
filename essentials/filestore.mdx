...
File Collections provide organizational structure for files stored in the File Storage system. When working with collections:

- Group related files such as templates, configurations, or documentation
- Maintain consistent metadata and access controls across files
- Reference file collections directly in workflows via slash commands
- Share collections with team members (View/Edit permissions)
- Apply bulk operations to multiple files simultaneously
