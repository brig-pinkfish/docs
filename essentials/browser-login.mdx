...
![Session recording view — live managed browser in the dialog with an "I've Logged in" button in the top right](/images/browser-login/browser-login-session-recording.png)
