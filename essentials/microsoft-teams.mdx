...
1. In the Pinkfish web app, open an agent and go to the **Channels** tab, or go to **Settings → Agents**. Find the **Microsoft Teams** row.
...
3. Toggle **Microsoft Teams** on.
   ...
   ![Agent editor Channels tab with Microsoft Teams toggle](/images/microsoft-teams/agent-editor-channels.png)
...
Attach files to a Teams message the same way you would in any other Teams chat. Pinkfish ingests the attachments and makes them available to the agent as inputs, the same way file uploads work in Coworker.
...
See the [Coworker](/essentials/coworker) guide for more on chat history, knowledge base selection, and sharing.
...
- **Per-agent mode:** open the agent editor, go to **Channels**, and toggle Microsoft Teams off. A toast confirms **"Microsoft Teams integration disabled"**.
- **Org-level mode:** open the agent editor, go to **Channels**, and toggle Microsoft Teams off. The toggle acts as an opt-out for that agent only; other agents stay reachable.
