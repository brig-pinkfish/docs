...
| **Human-in-the-Loop Integration**    | [HITL Workflows](/essentials/human-in-the-loop) + [Dynamic HTML Apps](/essentials/filestore)                               | Human approval gates, exception handling, ephemeral web interfaces, audit trails                             |
...
<CardGroup cols={2}>
  <Card title="Browser Login Sessions" icon="browser" href="/essentials/browser-logins">
