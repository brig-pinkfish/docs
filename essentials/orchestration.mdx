...
| **Scalable Resource Management**     | [Queue Policies](/essentials/queue) + [State Management](/essentials/database)                                            | Retry policies, state persistence, automatic scaling, resource optimization                                  |
...
| **Human-in-the-Loop Integration**    | [HITL Workflows](/essentials/human-in-the-loop) + [Dynamic HTML Apps](/essentials/file-store)                               | Human approval gates, exception handling, ephemeral web interfaces, audit trails                             |
| **Environment Promotion**            | [Dev/Stage/Prod Promotion](/essentials/promotion)                                                                          | Promotion paths, cross-org deployment, permission isolation, change control                                  |
...
<CardGroup cols={2}>
  ...
  <Card title="State Management" icon="database" href="/essentials/database">
...
<CardGroup cols={2}>
  <Card title="Browser Login Sessions" icon="browser" href="/essentials/browser-login">
...
<CardGroup cols={2}>
  <Card title="Dynamic Approval Gates" icon="user-check" href="/essentials/human-in-the-loop">
...
<CardGroup cols={2}>
  <Card title="Dev/Stage/Prod Promotion" icon="arrow-up-right-dots" href="/essentials/promotion">
