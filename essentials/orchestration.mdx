...
### **6. Secure & Reliable Integration Infrastructure**

Modern orchestration requires trusted, validated integration points that maintain security and reliability at scale. This includes verified connectors, secure protocol implementation, and continuous validation of integration functionality to ensure enterprise-grade reliability.
...
| **Integration & Extensibility**       | [100+ Connections](/essentials/connections) + [Code-Based Workflows](/essentials/steps)  | Built-in integrations, custom connections, unlimited workflow customization        |
| **Secure Integration Infrastructure** | [MCP Server Farm](/agents/mcps) + Nightly Validation                                     | Pinkfish-hosted MCP servers, security validation, continuous functionality testing |
...
<CardGroup cols={2}>
  <Card title="Connections" icon="plug" href="/essentials/connections">
    100+ built-in integrations with APIs and browser automation for services
    without APIs. Customers can add their own custom connections for unlimited
    extensibility.
  </Card>
...
<CardGroup cols={2}>
  <Card title="MCP Server Farm" icon="server" href="/agents/mcps">
    Pinkfish hosts and maintains its own Model Context Protocol (MCP) server
    farm. Each MCP server is created, tested, and validated by Pinkfish with
    nightly functionality and security testing.
  </Card>

  <Card title="Enterprise Security" icon="shield-check">
    Unlike third-party MCP servers, all integrations are verified and maintained
    by Pinkfish, ensuring enterprise-grade security, reliability, and consistent
    functionality across all connections.
  </Card>
</CardGroup>
...
Pinkfish hosts and maintains its own Model Context Protocol (MCP) server farm with 100+ integrations. Each MCP server is created, verified, and tested nightly by Pinkfish—ensuring enterprise-grade security, reliability, and consistent functionality without third-party dependencies.
