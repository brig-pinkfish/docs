...
| **Integration & Extensibility**      | [100+ MCP Connections](/agents/mcps) + [Code-Based Workflows](/essentials/steps)         | Pinkfish-hosted MCP server farm, nightly validation, unlimited workflow customization |
...
<CardGroup cols={2}>
  <Card title="MCP Server Farm" icon="server" href="/agents/mcps">
    ...
    farm with 100+ integrations. Each MCP server is created, tested, and
    validated by Pinkfish with nightly functionality and security testing.
  </Card>
