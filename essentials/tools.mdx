...
<CardGroup cols={3}>
  ...
  <Card title="Embedded Services" icon="puzzle-piece" href="/essentials/embedded-services">
  ...
  <Card title="Custom MCP Servers" icon="server" href="/essentials/custom-mcp-servers">
...
<CardGroup cols={2}>
  ...
  <Card title="File Store" icon="folder" href="/essentials/file-store">
    Unstructured file collections for documents, exports, uploads, and generated artifacts.
  </Card>
  <Card title="Knowledge Base" icon="brain" href="/essentials/knowledge-base">
...
<Card title="Browser Login" icon="browser" href="/essentials/browser-login">
...
- Start with [Connections](/essentials/connections) to wire up your first third-party app.
- Spin up a [Database](/essentials/database) or [Knowledge Base](/essentials/knowledge-base) to give your agent something to read and write.
- Review [Embedded Services](/essentials/embedded-services) for the capabilities that ship with Pinkfish.
