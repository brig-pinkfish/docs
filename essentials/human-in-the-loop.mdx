...
- **[Datastore](/essentials/database)**: Stores human decisions and approval data
- **[File Storage](/essentials/file-store)**: Hosts ephemeral HTML applications
...
- **[State Management](/essentials/database)**: Persistent approval state across workflow executions
