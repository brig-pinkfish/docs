...
Workflows reference secrets through the [`/get-secret` slash command](/api-reference/mcp-servers/embedded/vault) and the built-in [Vault MCP server](/api-reference/mcp-servers/embedded/vault). The pattern:
