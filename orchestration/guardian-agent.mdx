...
<Steps>
  ...
  <Step title="Guardian surfaces the problem in Notifications">
    ...
    <Frame caption="Notifications bell with unread count">
      <img src="/images/guardian-agent/guardian-agent-bell-close.png" alt="Notifications bell showing a red 15-unread badge" />
    </Frame>
    ...
    ![Notifications panel showing workflow error cards](/images/guardian-agent/guardian-agent-notifications-panel.png)

    <Frame caption="A single error card — 'This workflow has encountered errors from triggered runs.'">
      <img src="/images/guardian-agent/guardian-agent-error-card-close.png" alt="Close-up of a Guardian error notification card with a Review button" />
    </Frame>
    ...
    ![Guardian Agent panel showing error summary and Top Errors list](/images/guardian-agent/guardian-agent-panel-error-summary.png)
  </Step>

  <Step title="Start a new analysis">
    Inside the Guardian Agent panel, click **How to fix it**, then **Start New Analysis**:

    ![How to fix it tab with Start New Analysis call-to-action](/images/guardian-agent/guardian-agent-how-to-fix.png)
    ...
    ![Guardian Agent chat showing the analysis kicking off](/images/guardian-agent/guardian-agent-starting-analysis.png)
  ...
  <Step title="Chat with the Guardian Agent">
    ...
    When the analysis finishes, the chat shows the Guardian's reasoning inline and the right-hand panel fills in with a full **Workflow Error Analysis Report** — total errors, error type, the specific node at fault, and a step-by-step **Coding Prompt** describing the exact change to make:

    ![Guardian Agent analysis complete — chat reasoning on the left, error summary and coding prompt on the right](/images/guardian-agent/guardian-agent-analysis-complete.png)
