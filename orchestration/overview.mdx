...
| **Integration & Extensibility**      | [MCP Server Farm](/agents/mcps) + [100+ Integrations](/tools/connections) + [Code-Based Workflows](/workflows/node-types) | Pinkfish-hosted MCP servers for AI agents, 100+ authenticated integrations, unlimited workflow customization |
...
<CardGroup cols={2}>
  ...
  <Card title="Code-Based Flexibility" icon="code" href="/workflows/node-types">
...
**Ready to orchestrate your automation ecosystem?** Start with our [Quickstart Guide](/introduction) or explore [Workflow Creation](/workflows/overview).
