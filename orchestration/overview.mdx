...
| **Comprehensive Monitoring**         | [Workflow Monitor](/orchestration/monitor) + [Agent Monitor](/orchestration/monitor)                                       | Real-time tracking, performance analytics, unified agent & workflow visibility                               |
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Monitor" icon="robot" href="/orchestration/monitor">
