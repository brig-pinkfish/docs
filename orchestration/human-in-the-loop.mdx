...
<Frame>
  <img src="/images/orchestration/human-in-the-loop/approval-node-on-canvas.png" alt="Approval node on the agentic editor canvas with three labeled output handles — notify (blue), approved (green), and denied (red) — wired next to the Manual Trigger." />
</Frame>
...
<Frame>
  <img src="/images/orchestration/human-in-the-loop/approval-node-settings.png" alt="Approval node settings panel in the agentic editor showing Name, Preamble textarea, Link expiration (minutes), and the Allow public access toggle." />
</Frame>
...
- **[Email Notifications](/api-reference/mcp-servers/embedded/email)**: Detailed context with approval links
- **[SMS Alerts](/how-to/sms-trigger)**: Urgent notifications for time-sensitive approvals
- **[Slack Messages](/api-reference/mcp-servers/application/slack)**: Team notifications with workflow context
- **[Microsoft Teams](/api-reference/mcp-servers/application/microsoft-teams)**: Enterprise collaboration notifications
