...
1. Open an agentic workflow in the [agentic editor](/workflows/overview).
...
**Ready to add human oversight to your automations?** Start with our [Workflow Creation Guide](/workflows/overview) or explore [Trigger Configuration](/triggers/event-triggers).
