...
<img src="../images/examples/producer.png" alt="Producer-Consumer Pattern Diagram" />

> **Note**: The easiest way to set up this pattern is to put your producer on a scheduled trigger. So it'll go get new jobs every time it runs.
