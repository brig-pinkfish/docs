...
[See the complete Gmail Guide →](/api-reference/mcp-servers/application/gmail)
...
[See the complete Microsoft Outlook Guide →](/api-reference/mcp-servers/application/microsoft-outlook)
...
[See the complete Formatted Email Guide →](/api-reference/mcp-servers/embedded/email)
