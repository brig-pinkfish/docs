...
You can generate personalized signed links from either an **agent in Chat Mode** or a **workflow step**. Both approaches use the same filestorage skill.

### Option A: Generate from Chat Mode

Enter a prompt like this in Chat Mode:
