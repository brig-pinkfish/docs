...
#### 1a. Attach an API Trigger (to your worker automation)
As part of the item creation process, attach a trigger to another of your automations. The automation that you trigger will be your worker automation. It will receive a payload containing details about the job (the item's content and metadata).
