...
- <Icon icon="circle-info" color="#fffb00" />**Important Note: T**  his feature upgrade may require manual steps on your end to ensure the automation functions as expected.
