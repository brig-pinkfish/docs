...
**Major Features:**
- **🛠️ MCP Tool Testing** - Easy testing interface for each MCP tool
- **🏢 Enhanced Integrations** - Added MS 365 Suite and Monday.com connectors
...
**Major Features:**
- **💬 Dynamic Input Prompting** - Users can specify inputs via prompting with automatic frontend updates
