...
- **Enhanced MCP Server Support** - NEW: Workflows can now be integrated into bespoke MCP servers for custom automation flows
- **Groq Maverick Model** - NEW: Added Groq Maverick to available models for faster inference
...
- **Tool Selection Streaming** - Backend improvements for real-time tool selection streaming
- **CORS and Logging Enhancements** - Better cross-origin support and improved logging in chat server and handlers
- **Debug Report Improvements** - Enhanced debugging capabilities with better error reporting
...
- **Input Schema Support** - NEW: Backend support for input schemas in automation payloads
- **Expected Inputs for Triggers** - NEW: Enhanced trigger system with expected input definitions
...
- **Prompt Content Filtering** - Backend improvements for context-based prompt filtering
- **Designated Output Support** - Enhanced workflow output handling
...
- **Datastore Search Functionality** - NEW: Enhanced search capabilities within datastore collections
...
- **Outlook Tool Updates** - Enhanced Microsoft Outlook integration with better functionality
- **SharePoint Tool Improvements** - Better SharePoint integration and tool support
...
- **AI Agent Long-term Memory** - NEW: Agent memory server for persistent context across conversations
- **PDF Conversion** - NEW: Convert various file formats to PDF
...
- **Agent File Context** - Refreshed signed URLs for better file handling in agent chats
- **Google Drive Enhancements** - Better file upload handling and content retrieval
...
- **Agent Chat File Processing** - NEW: Enhanced file message processing in agent conversations
- **File Conversion and Extraction** - NEW: Comprehensive file processing capabilities
...
- **Tool Selection with Planning** - Advanced tool selection mode with planning capabilities
...
- **Zendesk Pagination** - NEW: Enhanced Zendesk integration with pagination and filtering support
- **Artifact Listing Helper** - NEW: Better artifact management and listing capabilities

### ⚡ Improvements

- **Collection Mapping** - Better type matching and error handling
- **Dependent Connection Handling** - Enhanced connection management for dependent services
- **Webhook Support** - Zoom and SmartSheets webhook integration
...
- **Think MCP Server** - NEW: Code execution and thinking capabilities for agents
- **File Import from URL** - NEW: Import files directly from URLs
...
- **CloudFront Proxy Configuration** - Added new services to proxy configuration
- **MCP Tool Calling** - Tool calling support within skills (SharePoint and OneDrive)
...
- **Agent Backend Migration** - NEW: Migrated agent system from Firebase to DynamoDB for better performance
...
- **User Agent and Chat Endpoints** - Enhanced backend endpoints for better performance
...
- **Salesforce MCP Integration** - NEW: Comprehensive Salesforce MCP server support
- **Airtable MCP Integration** - NEW: Airtable automation capabilities
...
- **Integration Test Infrastructure** - Enhanced MCP integration testing framework
- **Chat CRUD Operations** - Full PUT/POST/DELETE support for chats
...
- **Pinkfish Utilities MCP Server** - NEW: Enhanced MCP server with utilities and Firecrawl integration
- **Google Sheets Enhancements** - NEW: Fixed column and row handling issues
...
- **Agent ID Metadata** - Enhanced automation metadata with agent information
- **LLM Model Selection** - Improved model selection capabilities
- **Triggers for Agents** - Enhanced trigger system for agent endpoints
...
- **HubSpot MCP Integration** - NEW: Comprehensive HubSpot tools and MCP server
- **Zoom MCP Server** - NEW: Zoom integration for automation workflows
...
- **MCP Server Organization** - Renamed MCP servers to match skill IDs for better consistency
- **Queue Processor Health** - Enhanced monitoring for stuck queues and processor health
...
- **ServiceNow MCP Integration** - NEW: ServiceNow automation capabilities
- **Microsoft Word MCP** - NEW: Word document automation tools
...
- **OpenAPI Spec Integration** - Enhanced Pinkfish tools with OpenAPI specifications
- **Tool List Filtering** - Better tool filtering capabilities
- **Datastore/FileStorage/Vault Resources** - Enhanced resource management system
...
- **Zendesk MCP Server** - NEW: Comprehensive Zendesk automation
- **Run Type Filtering** - NEW: Enhanced reporting with run type filters
- **Automation Run History** - NEW: Get last runs for automation tracking
...
- **Slack Webhook Support** - Enhanced webhook challenge handling
- **GPT Model Updates** - Updated GPT model choices and availability
- **Webhook URL Management** - Enhanced webhook URL handling
...
**Enhanced Backend Infrastructure** - Significant backend improvements including:

- **Pinkfish Server Integration** - Enhanced server capabilities with better tool integration
- **Agent Decision Context** - Better UI for showing agent decisions in conversation context
- **Email Domain Support** - Enhanced email domain filtering and management
