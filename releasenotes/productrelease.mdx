...
**Key Improvements:**
- Better identification and handling of published automation types
- Enhanced gallery browsing experience
- Improved browser automation workflows

**Top Bug Fixes:**
- Fixed published automation type identification issues
...
**Major Features:**
- **🧪 MCP Tool Testing** - Easily test Model Context Protocol tools
...
- Better MCP tool testing interface

**Top Bug Fixes:**
- Fixed incorrect index in trigger modal output options
- Resolved websocket streaming issues
...
- Enabled deletion from non-quoted collections like multimedia artifacts
