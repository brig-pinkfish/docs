...
Pinkfish provides a comprehensive workflow platform with included resources at every subscription level. Credits are a flexible way to extend your workflows with built-in value added services. Credits are only needed for these optional premium services that extend capabilities beyond what is included in the platform.
...
For a detailed breakdown of the specific limits and allocations for each subscription tier, please refer to our [Limits](/billing/limits) documentation.
...
For a complete list of features available on each plan and the resource limits that apply, see our [Limits](/billing/limits) documentation.

## Credit Allocation by Plan

Each subscription plan includes a specific credit allocation:

- **Starter Plan**: 1,000 free credits for the 30-day trial period
- **Pro Plan**: 5,000 credits per month included
- **Team Plan**: 25,000 credits per month included
- **Enterprise Plan**: Custom credit allocations

For detailed pricing information and additional credit rates, please refer to our [Pricing](/billing/pricing#additional-credit-pricing) documentation.
...
| Word Document Processor | Per Page      | 5       | AI-powered Word document editing   |
| **File Storage**        |               |         |                                    |
...
| **Media Processing**    |               |         |                                    |
| Image Generate          | Per Request   | 16      | AI image generation (Replicate Gemini Flash)      |
| Image Edit              | Per Request   | 16      | AI text-based image editing (Replicate Nano-Banana) |
| Replicate Models        | Per Request   | 10      | Other Replicate AI models          |
| Video Generate          | Per Request   | 834     | AI video generation (Replicate Veo)               |
| **Security**            |               |         |                                    |
...
Usage of these services is subject to the concurrency and rate limits detailed in our [Limits](/billing/limits) documentation.
