...
<Frame>
  <img src="/images/agentic-editor/overview/editor-empty.png" alt="Empty Agent Mode editor — chat panel on the left, canvas with the default Manual Trigger in the center, tab bar across the top with Release on the right." />
</Frame>
