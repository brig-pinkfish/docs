...
If your workflow uses browser automation, you'll see a live browser view embedded in the Browser Session panel of the chat. The agent's clicks and typing stream in real-time so you can debug selector issues without re-running. See [Browser Logins](/essentials/browser-logins) for managing browser connections.
