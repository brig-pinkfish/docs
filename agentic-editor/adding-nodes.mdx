...
{/* TODO screenshot: Add Node panel open on the Nodes tab, showing the full list of categories. */}
...
{/* TODO screenshot: Triggers tab showing the list of trigger types. */}
...
{/* TODO screenshot: Interface tab showing the lone Add Interface card with its footnote. */}
