...
<Frame>
  <img src="/images/agentic-editor/chat/conversation.png" alt="Chat panel showing a user prompt asking for a weather-email workflow and the coding agent's response with a todo list tracking build steps." />
</Frame>
...
- **Skills** — call a saved skill by name (see [Skills](/essentials/skills)).
- **Files** — attach a file from your Filestore (see [Filestore](/essentials/filestore)).
- **Data Collections** — reference a collection for the agent to read from (see [Datastore](/essentials/datastore)).
- **User Agents** — `@`-mention another agent the coding agent can delegate to.
- **Browser Connections** — hand a logged-in browser session to the agent for web automation (see [Browser Logins](/essentials/browser-logins)).
...
| | Coding Agent (here) | [Coworker](/essentials/coworker) |
| --- | --- | --- |
