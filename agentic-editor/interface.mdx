...
<Frame>
  <img src="/images/agentic-editor/interface/interface-tab-open.png" alt="Interface tab open in the right pane on a new workflow, prompting 'First add a node to the workflow to enable adding an Interface.'" />
</Frame>
