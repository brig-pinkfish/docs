...
<Frame>
  <img src="/images/agentic-editor/releases/restore-version-dropdown.png" alt="Restore Version dropdown open with V2 (current) marked and a V1 entry with a Restore button, each labeled with a timestamp." />
</Frame>
...
<Frame>
  <img src="/images/agentic-editor/releases/public-template-section.png" alt="Release dropdown open showing the Release History entry with the Make Available as Public Template toggle switched on, the generated public URL, and a Copy button." />
</Frame>
