...
<Frame>
  <img src="/images/agentic-editor/actions-menu/dropdown.png" alt="Workflow actions dropdown open from the chevron next to the workflow title — Description, Tag, Share, Duplicate, Delete, Rename, and Setup Integrations and Resources entries visible." />
</Frame>
