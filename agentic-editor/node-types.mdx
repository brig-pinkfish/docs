...
<Frame>
  <img src="/images/agentic-editor/node-types/code-block-settings.png" alt="Code Block node settings panel with Name, Prompt, Summary, and a Retry on Error toggle — the hover menu above the node showing edit, play, mock, and pin icons." />
</Frame>
...
<Frame>
  <img src="/images/agentic-editor/node-types/flow-control-list.png" alt="Flow Control category open in the Add Node panel showing If-Else, Router, Merge, For Each, Delay, Loop, While, Parallel, and Approval." />
</Frame>
