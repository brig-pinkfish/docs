...
<Frame>
  <img src="/images/agentic-editor/editor-tabs/tab-bar.png" alt="The tab bar at the top of the right pane showing Workflow, Result, Interface, the pin menu, and Split toggle." />
</Frame>
...
<Frame>
  <img src="/images/agentic-editor/editor-tabs/result-tab.png" alt="Result tab showing a Run Summary list of completed nodes on the left and a populated JSON output on the right with id, name, and email fields." />
</Frame>
...
<Frame>
  <img src="/images/agentic-editor/editor-tabs/code-tab.png" alt="Code tab showing the generated TypeScript source of the workflow in a Monaco editor, with the Run Summary list on the left." />
</Frame>
...
<Frame>
  <img src="/images/agentic-editor/editor-tabs/pin-menu.png" alt="Pin menu popover open from the + button on the tab bar, showing the pinnable tabs." />
</Frame>
