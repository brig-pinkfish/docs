...
<CardGroup cols={2}>
  ...
  <Card title="Global Monitor" icon="chart-column" href="/essentials/monitor">
    Org-wide run observability.
  </Card>
  <Card title="Guardian Agent" icon="shield" href="/essentials/guardian-agent">
